...
if __name__ == '__main__':
    ...
    logger.info('##############################################################################################')
    logger.info('#                      ____     __    _____   __   __ ______ __     __ _____                 #')
    logger.info('#                     / __ \   / /   / ___ \ / /  / // ____//  |   / // ___ \                #')
    logger.info('#                    / /_/ /  / /   / /  /_// /__/ // /___ /   |  / // /  /_/                #')
    logger.info('#                   / ____ \ / /   / /     / ___  // ____// /| | / // /_____                #')
    logger.info('#                  / /   / // /   / /  __ / /  / // /    / / | |/ // //_  _/                #')
    logger.info('#                 / /___/ // /   / /__/ // /  / // /___ / /  |   // /__/ /                  #')
    logger.info('#                 \______//_/    \_____//_/  /_//_____//_/   |__/ \_____/                    #')
    logger.info('#                                                                                            #')
    logger.info('#                                __      _____   __  __ ______                               #')
    logger.info('#                               / /     / ___ \ / / / // ____/                               #')
    logger.info('#                              / /     / /  / // / / // /___                                 #')
    logger.info('#                             / /     / /  / // / / // ____/                                 #')
    logger.info('#                            / /     / /  / // / / // /                                      #')
    logger.info('#                           / /____ / /__/ / \ \/ // /___                                    #')
    logger.info('#                          /______/ \_____/   \__//_____/                                    #')
    logger.info('#                                                                                            #')
    logger.info('#       ____   __   __ ______ __     __ _____      ____   __    __  __  __ ______ __     __  #')
    logger.info('#      / __ \ / /  / // ____//  |   / // ___ \    / __ \ / /   / / / / / // ____//  |   / /  #')
    logger.info('#     / / /_// /__/ // /___ /   |  / // /  /_/   / / /_// /   / / / / / // /___ /   |  / /   #')
    logger.info('#     \ \   / ___  // ____// /| | / // /_____    \ \   / /   / / / / / // ____// /| | / /    #')
    logger.info('#   __ \ \ / /  / // /    / / | |/ // //_  _/  __ \ \ / /   / / / / / // /    / / | |/ /     #')
    logger.info('#  / /_/ // /  / // /___ / /  |   // /__/ /   / /_/ // /    \ \/  \/ // /___ / /  |   /      #')
    logger.info('#  \____//_/  /_//_____//_/   |__/ \_____/    \____//_/      \__/\__//_____//_/   |__/       #')
    logger.info('#                                                                                            #')
    logger.info('#                                                                                            #')
    logger.info('##############################################################################################')
