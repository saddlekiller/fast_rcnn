...
class Conv2D():
    ...
    def __init__(self, ksize, in_channels, out_channels, use_bias=True):
        if type(ksize) == int:
...
class Conv2D3x3(Conv2D):
    ...
    def __init__(self, in_channels, out_channels, use_bias=True):
        super(Conv2D3x3, self).__init__(3, in_channels, out_channels, use_bias)

class Conv2D7x7(Conv2D):

    def __init__(self, in_channels, out_channels, use_bias=True):
        super(Conv2D7x7, self).__init__(7, in_channels, out_channels, use_bias)

class Conv2D1x1(Conv2D):

    def __init__(self, in_channels, out_channels, use_bias=True):
        super(Conv2D1x1, self).__init__(1, in_channels, out_channels, use_bias)
